...
const initialState = {
  ...
  combatPageCardsCollapsed: { player: false, combat: false, conditions: false, animalCompanion: false, familiar: false, specialMount: false, items: false, carry: false, money: false },
