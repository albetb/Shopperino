...
- [magic-items.md](magic-items.md) — **Magic Items** — Item creation cost formulas, item-creation feat mechanics. Item categories, activation methods, slots, and identification will be added from later chapters.
